                ...
                <div className="border-x border-primary/10 bg-[url('/images/about-me/about-me-bg.svg')] bg-cover bg-center bg-no-repeat">
                    <div className="flex flex-col gap-9 sm:gap-12 max-w-3xl mx-auto px-4 sm:px-7 py-11 md:py-20">
                        <div className="flex flex-col gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[32px]">Hey there. I'm Hamed — Product strategy and UX design specialist, currently <span className="bg-[linear-gradient(90deg,_rgba(243,202,77,0.4)_0%,_rgba(243,202,77,0.05)_100%)]">crafting digital experiences</span>.</h2>
                            <h5 className="text-secondary font-normal">My work sits between product thinking, user flows, application concepts, and learning tool design.</h5>
                        </div>
                        <div className="flex flex-col gap-4">
